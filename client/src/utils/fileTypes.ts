...
const mimeMap: Record<string, FileTypeInfo> = {
  ...
  'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': { label: 'Excel', icon: DataTable, category: 'spreadsheet', previewable: true },
  'application/vnd.ms-excel': { label: 'Excel', icon: DataTable, category: 'spreadsheet', previewable: true },
  'text/csv': { label: 'CSV', icon: DataTable, category: 'spreadsheet', previewable: true },
