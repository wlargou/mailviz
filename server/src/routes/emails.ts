...
router.post('/batch/read', emailController.batchMarkAsRead);
router.post('/batch/unread', emailController.batchMarkAsUnread);
router.post('/batch/archive', emailController.batchArchive);
router.post('/batch/trash', emailController.batchTrash);
